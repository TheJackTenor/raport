...
<div class="content-wrapper">
  ...
  <div class="row">
        <div class="col-xs-12">
          <div class="box box-success @if($errors->has('file')) collapsed-box @endif">
            <div class="box-header with-border">
              <h3 class="box-title"><small>Kelas : </small>{{Session::get('charkelas')}} || <small>Pelajaran : </small> {{Session::get('charpelajaran')}} || <small>KKM Mapel : </small>{{$infonilai->ckmsikap}} || <small>Semester : </small>{{Session::get('semester')}} || <small>Tahun Ajaran : </small>{{Session::get('tahunajaran')}}</h3></h3>
            ...
            <div class="table-responsive">
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  @if($k==1)
                   <th class="warning"><p style="color: red;text-align: center;">Guru BK belum memasukkan daftar KD !</p></th>
                  @endif
                 
                </tr>

                {{Form::open(array('role'=>'form','url'=>'kompentensi/aspeksikap/spiritual/simpan','enctype'=>'multipart/form-data'))}}
                @php
                  $a = 0;
                @endphp
                ...
                <tr>
                  ...
                  @foreach($spiritual as $spirituals)
                    @if($spirituals->id_siswa == $datasiswas->id)
                      ...
                      <td align="center"><input type="text" class="form-control" tabindex="-1" name="tt{{$a}}" id="tt{{$a}}" readonly="readonly" style="width: 60px;margin-top: 30px" ></td>
     ...
     {{Form::open(array('role'=>'form','url'=>'kompentensi/aspeksikap/spiritual/upload','enctype'=>'multipart/form-data'))}}
            <div class="box-body">
