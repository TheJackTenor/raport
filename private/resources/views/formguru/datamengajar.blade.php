          ...
          @endif
            ...
            @endif
              <table id="example1" class="table table-bordered table-hover">
                ...
                @endforeach
                @if($memoryid!=="")
                <td width="15%"><center><a href="{{URL('/manajemenguru/guru/datamengajar/hapus')}}/{{$memoryid}}"><button class="btn btn-danger btn-flat btn-xs">Hapus</button></a> <a href="{{URL('/manajemenguru/guru/datamengajar/edit')}}/{{$memoryid}}"><button class="btn btn-warning btn-flat btn-xs">Edit</button></a></center></td>
                @endif
                </tbody>
                <tfoot>
                <tr>
...
<div class="row">
        ...
        <div class="col-md-12">
          ...
          @endif
            ...
            @if(Session::has('status'))
              @else
            {{Form::open(array('role'=>'form','url'=>'/manajemenguru/guru/datamengajar/prosestambahdatamengajar'))}}

            {{Form::hidden('id_guru',session()->get('id_guru'))}}
              <div class="box-body">
...
@if(Session::has('status'))
        ...
        <div class="col-md-12">
          ...
          <div class="box box-warning">
            ...
            {{Form::open(array('role'=>'form','url'=>'/manajemenguru/guru/datamengajar/proseseditdatamengajar'))}}
           ...
           <button type="submit" class="btn btn-success btn-flat">Simpan</button>
                 {{Form::close()}}
                 <a href="{{URL::asset('/manajemenguru/guru/datamengajar')}}"><button type="button" class="btn btn-warning btn-flat">Kembali</button></a>      
          </div>
          </div>
          </div>
@endif
