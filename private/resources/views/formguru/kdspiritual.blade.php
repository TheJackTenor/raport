        ...
        <div class="col-md-9">
          <div class="box box-success">
            <div class="box-header with-border">
              ...
              <button class="btn btn-success" type="button" id="difol"></button>  <b style="color: green">KD Spiritual Default</b> || <button class="btn btn-warning" type="button" id="clear"></button>  <b style="color: orange">Kosongkan</b>
              </div>
            </div>
            ...
            <div class="form-group {{ $errors->has('kd1') ? 'has-error' : ''}}"> 
                ...
                @endfor           
             @endif
              <button type="submit" class="btn btn-success">Simpan KD</button>
              {{Form::close()}} 
