...
<div class="content-wrapper">
  ...
  <div class="row">
        <div class="col-xs-12">
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title"><small>Kelas : </small>{{Session::get('charkelas')}} || <small>Pelajaran : </small> {{Session::get('charpelajaran')}} || <small>KKM Mapel : </small>{{$infonilai->ckmpengetahuan}} || <small>Semester : </small>{{Session::get('semester')}} || <small>Tahun Ajaran : </small>{{Session::get('tahunajaran')}}</h3>
            ...
            <div class="table-responsive">
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  @foreach($pengetahuan as $pengetahuans)
                    @if($pengetahuans->id_siswa == $datasiswas->id)
                      @php
                        $toggle = 1;
                        $idnow = $pengetahuans->id;
                        $i = 0;
                      @endphp
     ...
     {{Form::open(array('role'=>'form','url'=>'kompentensi/aspekpengetahuan/upload','enctype'=>'multipart/form-data'))}}
            <div class="box-body">
