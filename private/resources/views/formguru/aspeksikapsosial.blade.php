...
<div class="content-wrapper">
  ...
  <div class="row">
          ...
          <div class="box box-success">
            ...
            <div class="table-responsive" >
              <table class="table table-bordered">
                ...
                {{Form::open(array('role'=>'form','url'=>'kompentensi/aspeksikap/sosial/simpan','enctype'=>'multipart/form-data','style'=>'"position: absolute; top: 0; bottom: 0; left: 0; right: 0;"'))}}
                @php
                  $a = 0;
                @endphp
                ...
                <tr>
                  ...
                  @foreach($sosial as $sosials)
                    @if($sosials->id_siswa == $datasiswas->id)
                       @php
                        $toggle = 1;
                        $idnow = $sosials->id;
                        $i = 0;
     ...
     {{Form::open(array('role'=>'form','url'=>'kompentensi/aspeksikap/sosial/upload','enctype'=>'multipart/form-data'))}}
            <div class="box-body">
