...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>MAN</b>Maguwoharjo</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  {{Auth::user()->username}} - {{Auth::user()->hak_akses}}
...
@yield('content')
  ...
  <footer class="main-footer">
    ...
    <div class="pull-right hidden-xs">
      Sistem Informasi Manajemen Nilai MAN MAGUWOHARJO SLEMAN
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; 2016 <a href="#">MAN MAguwoharjo Sleman</a>.</strong> All rights reserved.
  </footer>
...
<script>
            $(document).ready(function(){window.setTimeout(function() {
               document.getElementById ('coll').click();}, 1000);
            });
</script>
@endif
