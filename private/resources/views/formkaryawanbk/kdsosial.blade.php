        ...
        <div class="col-md-9">
          <div class="box box-success">
            <div class="box-header with-border">
              ...
              <button class="btn btn-success btn-flat" type="button" id="difol"></button>  <b style="color: green">KD Sosial Default</b> || <button class="btn btn-warning btn-flat" type="button" id="clear"></button>  <b style="color: orange">Kosongkan</b>
              </div>
            </div>
