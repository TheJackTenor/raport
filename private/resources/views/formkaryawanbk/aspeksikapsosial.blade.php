...
<div class="content-wrapper">
  ...
  <div class="row">
          ...
          <div class="box box-success @if($errors->has('file')) collapsed-box @endif">
            ...
            <div class="table-responsive" >
              <table class="table table-bordered">
                ...
                {{Form::open(array('role'=>'form','url'=>'kompentensi/sosial/simpan','enctype'=>'multipart/form-data','style'=>'"position: absolute; top: 0; bottom: 0; left: 0; right: 0;"'))}}
                @php
                  $a = 0;
                @endphp
     ...
     {{Form::open(array('role'=>'form','url'=>'kompentensi/aspeksikap/sosial/uploadbk','enctype'=>'multipart/form-data'))}}
            <div class="box-body">
