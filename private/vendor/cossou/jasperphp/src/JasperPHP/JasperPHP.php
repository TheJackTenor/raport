...
class JasperPHP
{
    protected $executable = "/JasperStarter/bin/jasperstarters";
    ...
    public function process($input_file, $output_file = false, $format = array("xls"), $parameters = array(), $db_connection = array(), $background = true, $redirect_output = true)
    {
        if(is_null($input_file) || empty($input_file))
            throw new \Exception("No input file", 1);
